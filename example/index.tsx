...
import MentionPlugin from '../src/plugins/mention/MentionPlugin';
...
function App() {
    ...
    const suggestionFilter = (suggestion, state) => {
        if (state === null) {
            return true;
        }

        return suggestion.name.toLowerCase().indexOf(state.text.toLowerCase()) !== -1;
    };
